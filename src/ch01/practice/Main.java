...
public class Main {
    ...
    //문자열 리스트 만들어서 출력해보기
        ...
        //2. 확장 for 루프 이용하기, 훨씬 간단함
        for(String s:slist){
            System.out.println(s);
        }
        // 3.(slist한테)iterator 이용하기3.1. iterator 얻기 
        Iterator<String> it=slist.iterator(); //slist.iterator();iterator 호출, it에 저장
